...
print(f"Specific enthalpy at inlet: {h_inlet} kJ/kg")
print(f"Specific enthalpy at outlet: {h_outlet} kJ/kg")

# Calculate the required heat input using the specific enthalpies and mass flow rate
required_heat_input = m_dot * (h_outlet - h_inlet)  # Convert to kW
